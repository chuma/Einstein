...
bool TWSPackage::CreateEditor(void *inParentView)
{
	pEditor = PackageEditorCreate(this, inParentView);
	return true;
}
 ...
 */
void TWSPackage::AssociateFile(const char *inFilename)
{
